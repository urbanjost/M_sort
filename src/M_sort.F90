...
! ident_38="@(#) M_sort sort_quick_rx_complex_int32(3f) indexed hybrid quicksort of a real array"
...
! ident_39="@(#) M_sort sort_quick_rx_complex_int64(3f) indexed hybrid quicksort of a real array"
...
!>
!!##NAME
!!    sort_quick_compact(3f) - [M_sort] recursive quicksort of an array
!!    (LICENSE: CC-BY)
!!
!!##SYNOPSIS
!!
...
!!
!!##DESCRIPTION
!!    A quicksort using a very compact recursive algorithm.
!!
!!##BACKGROUND
